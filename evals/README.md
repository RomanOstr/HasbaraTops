...
- Deterministic assertions: URL identity, identifier allocation, lifecycle, graph, schema, Pending Sync, read-back, audit, and source-consistency expectations are executable tests.
